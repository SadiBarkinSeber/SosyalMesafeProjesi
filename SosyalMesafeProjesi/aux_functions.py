...
def plot_lines_between_nodes(warped_points, bird_image, d_thresh):
    ...
    #Yeterince yakını: 10 fit olarak işaretle
    ...
    # Gerçekten yakını: 6 fit olarak işaretle
...
def put_text(frame, text, text_offset_y=25):
    ...
    # metin başlangıç konumunu ayarlayın
    text_offset_x = frame.shape[1] - 400
    # iki piksellik küçük bir dolgu ile kutunun koordinatlarını yapın
    box_coords = (
